...
func (m *RoleManager) Create(r *Role, opts ...Option) error {
...
func (m *RoleManager) Read(id string, opts ...Option) (r *Role, err error) {
...
func (m *RoleManager) Update(id string, r *Role, opts ...Option) (err error) {
...
func (m *RoleManager) Delete(id string, opts ...Option) (err error) {
...
func (m *RoleManager) List(opts ...Option) (r *RoleList, err error) {
...
func (m *RoleManager) AssignUsers(id string, users []*User, opts ...Option) error {
...
func (m *RoleManager) Users(id string, opts ...Option) (u *UserList, err error) {
...
func (m *RoleManager) AssociatePermissions(id string, permissions []*Permission, opts ...Option) error {
...
func (m *RoleManager) Permissions(id string, opts ...Option) (p *PermissionList, err error) {
...
func (m *RoleManager) RemovePermissions(id string, permissions []*Permission, opts ...Option) error {
	p := make(map[string][]*Permission)
	p["permissions"] = permissions
